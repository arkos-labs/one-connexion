        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[10px] tracking-[0.18em] text-label uppercase">
              Gestion commerciale · Portefeuille &amp; facturation
            </span>
          </div>
          <h1 className="text-[28px] font-bold leading-tight tracking-[-0.02em] text-ink">Clients</h1>
        </div>
        <button
          onClick={load}
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {c.company ? (
                        ...
                        <span className="rounded-full bg-blue-50 px-2 py-0.5 text-[10px] font-bold text-blue-700">Particulier</span>
                      )}
                    </div>
